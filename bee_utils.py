...
# @click.option('--from_address', prompt='Sender account address', help='Sender account address')
# @click.option('--pk', prompt='Sender Private key', help='Sender account private key')
# @click.option('--to_address', prompt='Recipient account address', help='Recipient account address')
def set_env(rpc):
    #export values to ENV
    print(f'export GNOSIS_RPC={rpc}')
    os.system(f'export GNOSIS_RPC={rpc}')
    # os.system(f'export FROM={from_address}')
    # os.system(f'export PK={pk}')
    # os.system(f'export TO={to_address}')
